# Sample Routing Answers - Under-Tier Fail
...
gates: no-progress rule and failure cap
...
case_id: R11
tier: Tier 1
artifact: micro-intent only
routing: quick provider routing fix
gates: one local check

## R12
case_id: R12
tier: Tier 1
artifact: doc-only note
routing: tiny CLAUDE.md edit
gates: no live gate
