...
- hermes-overseer-dead-9w · both(runtime) · eval_built · canonical: agfunder-gaia/evals/failures/
...
- two-layer-index-status-drift · both(process) · eval_built · canonical: evals/failures/cases/two-layer-index-status-drift.md
...
- sandbox-fake-row-shape · process(process) · eval_built · canonical: evals/failures/cases/sandbox-fake-row-shape.md
- dispatch-double-launch · process(process) · eval_built · canonical: evals/failures/cases/dispatch-double-launch.md
- human-owned-blocker-grind · both(runtime) · seed · canonical: agfunder-gaia/evals/failures/
- op-hang-under-launchd · runtime(runtime) · eval_built · canonical: agfunder-gaia/evals/failures/
- pg-null-upsert-dup · runtime(runtime) · eval_built · canonical: agfunder-gaia/evals/failures/
...
- subprocess-dies-without-terminal-state · process(process) · eval_built · canonical: evals/failures/cases/subprocess-dies-without-terminal-state.md
...
- false-green-completion-claims · process(process) · eval_built · canonical: evals/failures/cases/false-green-completion-claims.md
