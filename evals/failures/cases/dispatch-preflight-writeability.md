...
eval_check: R12 dispatch preflight writeability fixture.
...
Canonical pack-layer case for writeability preflight. This dispatch was constrained by a no-git instruction, so the case remains seeded for the future dispatch wrapper.
