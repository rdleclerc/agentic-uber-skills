...
eval_check: "references/dispatch-and-sessions.md#orchestrator-ownership checklist asserts each landed SHA is ancestor of the target branch tip before a wave is declared landed; cross-repo suite wiring makes the tree loud."
eval_type: checklist
plan_items:
  - R12
status: seed
...
Canonical pack-layer case for parallel ref-level lost updates. `references/dispatch-and-sessions.md` is the pack contract home for orchestrator-owned git, receipt/tree reconciliation, worktree isolation, non-force-push reconciliation, and landed-SHA ancestor checks.
