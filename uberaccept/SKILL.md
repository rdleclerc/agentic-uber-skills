...
11. Agent Advocate final check for agentic work or agent failures
12. Architecture Steward final check
13. first-principles simplification and cost/complexity verdict, including any Basic Spine First veto
14. adversarial acceptance check
15. post-run learning decision for skill/workflow/agentic-system changes
16. confidence verdict and completion recommendation
